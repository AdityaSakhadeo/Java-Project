...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUsername = findViewById(R.id.editTextTextPersonName);
        setPassword = findViewById(R.id.editTextTextPassword2);
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i)
                {
                    case R.id.radioButton4:
                        Toast.makeText(MainActivity5.this, "Admin hit", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioButton5:
                        Toast.makeText(MainActivity5.this, "customer hit", Toast.LENGTH_SHORT).show();
                        break;
                }
